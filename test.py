...
def carlin_style_voiceover(text):
    """Generate a voiceover with gTTS"""
    try:
...
Ready to transform your career? DM us or visit soliditminds.com"""
        ...
        if st.button("Generate Voiceover (George Carlin-style)"):
            audio_file = carlin_style_voiceover(sample_post)
            if audio_file:
